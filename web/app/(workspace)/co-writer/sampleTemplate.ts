...
export const CO_WRITER_SAMPLE_TEMPLATE = `# QLearn Co-Writer

> QLearn's built-in writing canvas for notes, reports, tutorials, and AI-assisted drafts.
...
- A practical starter draft for QLearn product docs and learning content

## Headers (Underline)

QLearn Learning Note
=============

QLearn Study Outline
-------------
...
The <abbr title="Large Language Model">LLM</abbr> layer powers QLearn while the <abbr title="Retrieval Augmented Generation">RAG</abbr> layer provides grounded knowledge support.

### Blockquotes

> QLearn helps students turn questions into structured understanding.
>
> "Learn deeply, write clearly.", [QLearn](#qlearn-co-writer)

### Links

[QLearn Co-Writer](#qlearn-co-writer "co-writer section")

[QLearn Learning Note](#qlearn-learning-note)

[QLearn upstream documentation](https://deeptutor.info)
...
> QLearn brand mark used inside the co-writer template.
...
op=>operation: QLearn analyzes intent
...
${FENCE}seq
Student->QLearn: Ask for help
QLearn->KnowledgeBase: Load context
Note right of QLearn: Collect memory\\nand relevant knowledge
QLearn-->Student: Return guided response
Student->>QLearn: Request rewrite in co-writer
${FENCE}
