...
export default function FilePreviewDrawer({
  ...
  return (
    <div
      ...
      className={`fixed bottom-0 right-0 top-[65px] z-[30] flex w-full flex-col border-l border-[var(--border)] bg-[var(--card)] transition-transform ease-out md:w-[min(560px,92vw)] ${
